...
migrate: ## Apply SQL migrations to running DB
	@for f in $(ROOT)/sql/002_paper_trading.sql $(ROOT)/sql/003_factor_signals.sql $(ROOT)/sql/004_perturbation_daily.sql $(ROOT)/sql/005_perturbation_daily_asset_class.sql $(ROOT)/sql/006_perturbation_daily_z_trend.sql; do \
		echo "Applying $$f..."; \
