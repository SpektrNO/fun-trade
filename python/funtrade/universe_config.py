...
_DEFAULT_ETF: dict[str, Any] = {
    ...
    # Trending ETFs sit far from OU μ; without a floor, z_return clips at ±8 and ε
    # becomes weekly volume noise (Monday spike → Tuesday snap).
    "h0_sigma_floor": 0.02,
    "h0_band_sigma_mult": 2.0,
    "h0_seasonal_dow": False,
    "h0_mu_anchor_days": 252,
    "h0_macro_fair_scale": 1.0,
    "h0_realized_vol_sigma_frac": 0.35,
